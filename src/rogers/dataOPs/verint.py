...
class Verint(TableExtract):
    ...
    columns = {sessions_categories_table: "distinct sid, category_key",
               ...
               sessions_booked_table: "distinct CONCAT(unit_num, '0', channel_num) as speech_id_verint, sid",
               cbu_rog_conv_sumfct_table: "distinct SPEECH_ID_VERINT,customer_id as account_number,"
